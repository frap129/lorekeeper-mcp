...
## Purpose
Defines the complete Open5e v1 API client implementation for fetching D&D 5e content from legacy v1 endpoints. The v1 client provides access to monsters, classes, races, and magic items from the Open5e API using the older API structure.
