...
## Purpose
Complete the Open5e v2 API client by implementing all available endpoints, providing full coverage of the v2 API including items, creatures, reference data, rules, and metadata endpoints.
