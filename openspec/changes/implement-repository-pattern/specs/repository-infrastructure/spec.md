...
## Purpose
Introduce repository pattern layer to decouple data access from business logic, providing a clean abstraction over API clients and cache for improved testability and flexibility.
