...
- [x] Update test `test_lookup_spell_with_document_keys` to use `documents` parameter
- [x] Run test to verify it fails
- [x] Update `lookup_spell` function signature: remove `document` and `document_keys`, add `documents`
- [x] Update docstring examples and Args section
- [x] Update internal parameter handling
- [x] Run test to verify it passes
- [x] Run all spell_lookup tests
- [x] Commit

## Task 2: Update lookup_creature Tool

- [x] Update test `test_lookup_creature_with_document_keys` to use `documents` parameter
- [x] Run test to verify it fails
- [x] Update `lookup_creature` function signature: remove `document` and `document_keys`, add `documents`
- [x] Update docstring examples and Args section
- [x] Update internal parameter handling
- [x] Run test to verify it passes
- [x] Run all creature_lookup tests
- [x] Commit

## Task 3: Update lookup_equipment Tool

- [x] Update test `test_lookup_equipment_with_document_keys` to use `documents` parameter
- [x] Run test to verify it fails
- [x] Update `lookup_equipment` function signature: remove `document` and `document_keys`, add `documents`
- [x] Update docstring Args section
- [x] Update internal parameter handling (3 places: weapons, armor, magic items)
- [x] Run test to verify it passes
- [x] Run all equipment_lookup tests
- [x] Commit

## Task 4: Update lookup_character_option Tool

- [x] Update test `test_lookup_character_option_with_document_keys` to use `documents` parameter
- [x] Run test to verify it fails
- [x] Update `lookup_character_option` function signature: rename `document_keys` to `documents`
- [x] Update docstring Args section
- [x] Update internal parameter handling
- [x] Run test to verify it passes
- [x] Run all character_option_lookup tests
- [x] Commit
