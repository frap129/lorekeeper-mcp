# Open5e API Search Parameter Fix - Specification

**Spec ID**: `search-parameter-correction`
**Change ID**: `fix-open5e-api-issues`
**Component**: API Client Tools
...
None - this is a corrective change that maintains all existing functionality while fixing the parameter usage.
