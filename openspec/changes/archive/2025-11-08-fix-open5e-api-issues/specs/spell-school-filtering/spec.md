# Open5e API Spell School Filtering - Specification

**Spec ID**: `spell-school-filtering-implementation`
**Change ID**: `fix-open5e-api-issues`
**Component**: Open5e v2 Spell Client
...
if school:
    ...
    spells = [spell for spell in spells if spell.school.lower() == school_lower]
```
...
### Integration with Spell Lookup Tool
**Requirement**: The `lookup_spell` tool must continue to work seamlessly with the client-side filtering implementation.
