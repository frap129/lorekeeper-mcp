...
1. Read `changes/<id>/proposal.md`, `design.md` (if present), `tasks.md`, and `plan.md` to confirm scope and acceptance criteria.
2. Call the skills_subagent_driven_development tool and adhere to its workflow.
